...
my_lineplot <- function(data, x, y, group, title, xlab, ylab, grouplab, xticklabs, groupticklabs) {
  ...
  scale_color_discrete(labels=groupticklabs) + 
...
my_lineplot(
  ...
  xlab = "Held Controller",
  ylab = "Mean Reaction Time in Milliseconds",
  grouplab = "Displayed Controller",
  xticklabs = c("Heavy", "Light"),
  groupticklabs = c("Heavy", "Light")
)
```
...
data_long %>%
  ...
  get_summary_stats(rt_ms_mean, type = "mean_sd")
```
...
my_lineplot(
  ...
  xlab = "Held Controller",
  ylab = "Mean Traveled Projected Path of Pointer in Meters",
  grouplab = "Displayed Controller",
  xticklabs = c("Heavy", "Light"),
  groupticklabs = c("Heavy", "Light")
)
...
data_long %>%
  group_by(real_weight, virtual_weight) %>%
  get_summary_stats(path_mean, type = "mean_sd")
```
