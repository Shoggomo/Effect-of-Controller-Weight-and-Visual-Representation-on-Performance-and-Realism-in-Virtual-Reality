...
arranged_plot <- ggarrange(line_fac_1, line_fac_2, line_fac_3, nrow = 1, ncol = 3, legend = "bottom", common.legend = TRUE) +
  coord_fixed(ratio = 0.4)
...
ggsave(filename = "borg_figure.png", plot = barplot)
